...
namespace IIASA.WorldCereal.Rdm.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfObservationMethod = table.Column<int>(type: "integer", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                    FeatureCount = table.Column<long>(type: "bigint", nullable: false),
                    ConfidenceLandCover = table.Column<double>(type: "double precision", nullable: false),
                    ConfidenceCropType = table.Column<double>(type: "double precision", nullable: false),
                    ConfidenceIrrigationType = table.Column<double>(type: "double precision", nullable: false),
                    LandCovers = table.Column<int[]>(type: "integer[]", nullable: true),
                    CropTypes = table.Column<int[]>(type: "integer[]", nullable: true),
                    IrrTypes = table.Column<int[]>(type: "integer[]", nullable: true),
                    Extent = table.Column<Geometry>(type: "geometry", nullable: false),
                    FirstDateOfValidityTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    LastDateOfValidityTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_CollectionMetadata", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_ConsortiumColStatus",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DownloadZipUrl = table.Column<string>(type: "text", nullable: true),
                    ...
                    OverwriteFeatures = table.Column<bool>(type: "boolean", nullable: false),
                    OverwriteOtherProps = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_ConsortiumColStatus", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_DatasetEvents",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_DatasetEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidityTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ...
                    Irr = table.Column<int>(type: "integer", nullable: false),
                    UserConf = table.Column<int>(type: "integer", nullable: false),
                    ImageryTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    NumberOfValidations = table.Column<int>(type: "integer", nullable: true),
                    TypeOfValidator = table.Column<int>(type: "integer", nullable: true),
                    AgreementOfObservations = table.Column<int>(type: "integer", nullable: true),
                    DisAgreementOfObservations = table.Column<int>(type: "integer", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_Items", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_MetadataItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_MetadataItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Geometry = table.Column<Geometry>(type: "geometry", nullable: false),
                    Split = table.Column<int>(type: "integer", nullable: false),
                    ValidityStartTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ValidityEndTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_Sample", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_Store", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_UserDatasetBackups",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserDatasetId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_UserDatasetBackups", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_UserDatasets",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: true),
                    ...
                    Errors = table.Column<string[]>(type: "text[]", nullable: true),
                    MasterCollectionStoreInfoId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_UserDatasets", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "rdm_ValidationRules",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AttributeName = table.Column<string>(type: "text", nullable: true),
                    ValueChecks = table.Column<int[]>(type: "integer[]", nullable: true),
                    MandatoryType = table.Column<int>(type: "integer", nullable: false),
                    MissingErrorMessage = table.Column<string>(type: "text", nullable: true),
                    InvalidValueErrorMessage = table.Column<string>(type: "text", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_ValidationRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    Value = table.Column<string>(type: "text", nullable: true),
                    ValidationRuleId = table.Column<int>(type: "integer", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rdm_RuleValidValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_rdm_RuleValidValues_rdm_ValidationRules_ValidationRuleId",
                        column: x => x.ValidationRuleId,
                        principalTable: "rdm_ValidationRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_rdm_Items_Lc_Ct_Irr_UserConf_Area_Split_ValidityTime",
                table: "rdm_Items",
                columns: new[] { "Lc", "Ct", "Irr", "UserConf", "Area", "Split", "ValidityTime" });

            migrationBuilder.CreateIndex(
                name: "IX_rdm_RuleValidValues_ValidationRuleId",
                table: "rdm_RuleValidValues",
